<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Manage your client database</p>
        </div>
        <a href="{{ route('ops.clients.create') }}"
    ...
    <div class="bg-white rounded-2xl shadow-md p-4 mb-4 flex flex-col sm:flex-row gap-3">
        ...
        <select wire:model.live="segment"
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-100">
                        ...
                        <th class="text-left px-4 py-3 font-semibold text-gray-600">Company</th>
                        ...
                        <th class="text-left px-4 py-3 font-semibold text-gray-600">Segment</th>
                        <th class="text-left px-4 py-3 font-semibold text-gray-600">CLV</th>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-3">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-50 text-blue-700 capitalize">
                                {{ str_replace('_', ' ', $client->segment) }}
                            </span>
                        </td>
                        <td class="px-4 py-3 font-medium text-gray-900">{{ $client->clv_naira }}</td>
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-end gap-2">
                                <a href="{{ route('ops.clients.show', $client) }}"
                                   class="text-xs font-medium text-gray-600 hover:text-gray-900 px-2 py-1 rounded-lg hover:bg-gray-100 transition">
                                    View
                                </a>
                                <a href="{{ route('ops.clients.edit', $client) }}"
