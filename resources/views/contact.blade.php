...
@section('title', 'Contact Us — Alet Inspirationz Prints Limited')
...
<section class="relative bg-gray-900 overflow-hidden">
    ...
    <div class="relative max-w-6xl mx-auto px-4 py-24 text-center">
        <span class="inline-block bg-red-600/20 border border-red-500/40 text-red-300 text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-6">Get in Touch</span>
        ...
        <p class="text-lg text-gray-300 max-w-xl mx-auto">Have a question, project idea, or just want to say hello? We'd love to hear from you.</p>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-10">
                    ...
                    <p class="text-gray-500 text-sm mb-8">We typically respond within 24 business hours.</p>
                    ...
                    <form action="{{ route('contact.send') }}" method="POST" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="subject" required value="{{ old('subject') }}"
                                       ...
                                       class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition @error('subject') border-red-400 @enderror">
                        ...
                        <div>
                            ...
                            <textarea name="message" required rows="6"
                                      ...
                                      class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition resize-none @error('message') border-red-400 @enderror">{{ old('message') }}</textarea>
                            @error('message')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                        </div>

                        <button type="submit"
                                class="w-full bg-gradient-to-r from-red-600 to-red-700 text-white font-bold py-4 rounded-xl hover:from-red-700 hover:to-red-800 transition-all duration-300 hover:scale-[1.02] shadow-lg shadow-red-200 flex items-center justify-center gap-2">
                            Send Message
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-7">
                    <h3 class="font-bold text-gray-900 text-lg mb-5">Contact Information</h3>
                    <div class="space-y-5">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:info@aletinspirationz.com" class="text-gray-800 text-sm font-medium hover:text-red-600 transition-colors">info@aletinspirationz.com</a>
                            </div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 bg-red-100 rounded-xl flex items-center justify-center flex-shrink-0">
                            ...
                            <div>
                                ...
                                <a href="tel:+2348000000000" class="text-gray-800 text-sm font-medium hover:text-red-600 transition-colors">+234 800 000 0000</a>
                            </div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 bg-red-100 rounded-xl flex items-center justify-center flex-shrink-0">
                            ...
                            <div>
                                ...
                                <p class="text-gray-800 text-sm font-medium">Lagos, Nigeria</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {{-- Social Links --}}
                <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-7">
                    <h3 class="font-bold text-gray-900 text-base mb-5">Follow Us</h3>
                    <div class="space-y-3">
                        <a href="#" class="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors group">
                            ...
                            <span class="text-sm text-gray-700 font-medium group-hover:text-blue-600 transition-colors">aletinspirationzltd</span>
                        </a>
                        <a href="#" class="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors group">
                            <div class="w-9 h-9 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 rounded-lg flex items-center justify-center flex-shrink-0">
                            ...
                            <span class="text-sm text-gray-700 font-medium group-hover:text-pink-600 transition-colors">alet_inspirationz</span>
                        </a>
                        <a href="#" class="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors group">
                            ...
                            <span class="text-sm text-gray-700 font-medium group-hover:text-green-600 transition-colors">WhatsApp Us</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-red-600 to-red-800 rounded-2xl p-7 text-white">
                    <h3 class="font-bold text-lg mb-2">Need a Quote?</h3>
                    <p class="text-red-100 text-sm mb-5">Use our detailed quote form to get an accurate estimate for your project.</p>
                    <a href="{{ route('quote') }}"
                       class="inline-flex items-center gap-2 bg-white text-red-700 font-bold text-sm px-5 py-3 rounded-xl hover:bg-gray-50 transition-all duration-300 hover:scale-105">
                        Get a Quote
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
